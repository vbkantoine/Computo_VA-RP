...
plt.figure(figsize=(5, 4))
plt.plot(range_MI, target_w1(np.array(Div.keep_params['w1']).squeeze()), label=r'$\|w_1\|_2-1$')
plt.plot(range_MI, target_b1(Div.keep_params['b1']), label=r'$|b_1|$')
plt.plot(range_MI, target_w2_1(np.array(Div.keep_params['w2']).squeeze()), label=r'$\max(w_2^{-1}<0)$')
plt.plot(range_MI, target_w2_2(np.array(Div.keep_params['w2']).squeeze()), label=r'$\min(w_2^{-1}>0)$')
